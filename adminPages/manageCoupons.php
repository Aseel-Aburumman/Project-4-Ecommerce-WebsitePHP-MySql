...
<body>
    <div class="container-fluid">
        <nav style="padding:0; background-color: #8ba1fd61;" class="col-md-3 col-lg-2 d-md-block sidebar">
            <div class="position-sticky pt-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li lass="nav-item"><a style="background-color: #F1F0F0; color: #2943b1;" class="sidebarItems" class="nav-link" href="manageCoupons.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <h2 style="color: #2943b1;">List of Coupons</h2>
            <div class="d-flex mb-3">
                ...
                <div>
                    <a style="background-color: #2041c2d6; " class="btn btn-primary me-2" href="addCoupons.php" role="button">Add Coupons</a>
