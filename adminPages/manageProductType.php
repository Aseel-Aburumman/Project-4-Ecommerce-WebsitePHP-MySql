    ...
    <div class="container-fluid">
        <div class="row">
            <nav style="padding:0; background-color: #8ba1fd61;" class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li lass="nav-item"><a style="background-color: #F1F0F0; color: #2943b1;" class="sidebarItems" class="nav-link" href="manageProductType.php"> <i class="fas fa-tags"></i> Manage Product Type</a></li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h2 style="color: #2943b1;">List of Product Types</h2>
                <div class="d-flex mb-3">
                    <form class="d-flex me-3" method="get" action="">
                        <input class="form-control me-2" type="search" name="search" placeholder="Search Types" aria-label="Search">
                        <button class="btn btn-outline-success" type="submit">Search</button>
                    </form>
                    <div>
                        <a style="background-color: #2041c2d6; " class="btn btn-primary me-2" href="addRType.php" role="button">Add Product Type</a>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            $sql = $search ? "SELECT * FROM producttypes WHERE type_name LIKE '%$search%'" : "SELECT * FROM producttypes";
