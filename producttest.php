                ...
                <div class="features-wrapper">
                    ...
                    ?>
                        <div class="product-item" >
                            <div class="product-item-image" style="margin-top:10vh">
                                <a href="product-details.php?id=<?php echo $product['product_id']; ?>"><img src="dist/images/product/<?=$product['image'];?>" alt="Product Name"
                                            class="img-fluid"></a>
                                <div class="cart-icon">
