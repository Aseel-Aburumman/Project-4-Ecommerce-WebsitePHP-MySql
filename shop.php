                ...
                <div class="d-none d-lg-block">
                    <nav class="menu-area d-flex align-items-center">
                        ...
                        <ul class="main-menu d-flex align-items-center">
                            ...
                            <li><a href="shop.php?gender=children">Children</a></li>
                    ...
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.php?id=<?php echo $product['product_id']; ?>">
                                ...
                                <img src="<?=$src?>" alt="<?php echo $product['product_name']; ?>" class="img-fluid">
                            </a>

                            <div class="cart-icon">

                                <form method="post" action="wishlistAction.php" target="wishlist-frame-<?php echo $product['product_id']; ?>" style="display:inline;">
                                    ...
                                    <button type="submit" style="border:none; background:white; width:30px;height:30px; border-radius: 50%; padding:3px; margin-right: 3px;">
                                        <i id="wishlist-icon-<?php echo $product['product_id']; ?>" class="far fa-heart"></i>
                                    </button>
                                </form>
