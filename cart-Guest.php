...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {
    if ($_POST['action'] == 'update_quantity') {
        ...
        if (($key = array_search($product_id, $_SESSION['cart'])) !== false) {
            ...
            unset($_SESSION['cart_quantities'][$product_id]); // Remove the quantity as well
                ...
                <div class="col-lg-12">
                    ...
                    <div class="dashboard-nav">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><a href="wishlist - Guest.php">My wishlist</a></li>
                    ...
                    <div class="body">
                        ...
                        ?>
                                    <div class="item" data-product-id="<?php echo $product_id; ?>">
                                        ...
                                        <div class="price">
                                            <span class="unit-price"><?php echo '$' . number_format($unitPrice, 2); ?></span>
                                        </div>
                                        <div class="info">
                                            <div class="size">
